...
public class RegistrationController {
    ...
    final String url = "http://bc737dd5e1b2.ngrok.io";
    ...
    public ResponseEntity<?> registerOAuth2User(@RequestBody User userObj) throws Exception {
        ...
        if (tempPassword.equals(tempConfirmPassword)) {
            user.setPassword(service.getEncodedString(tempPassword));
            user.setConfirmPassword(service.getEncodedString(tempConfirmPassword));
